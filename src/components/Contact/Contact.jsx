            ...
            <div className="contact-info lg:w-1/2">
              ...
              <div className="space-y-8">
                <div className="flex items-center space-x-6 group">
                  ...
                  <div>
                    <h3 className="text-gray-400 text-xs font-bold uppercase tracking-widest mb-1">{t('contact.emailLabel')}</h3>
                ...
                <div className="flex items-center space-x-6 group">
                  ...
                  <div>
                    <h3 className="text-gray-400 text-xs font-bold uppercase tracking-widest mb-1">{t('contact.whatsappLabel')}</h3>
