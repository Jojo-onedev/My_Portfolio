              ...
              >
                ...
                <div className="px-2">
                  ...
                  <div className="pt-6 border-t border-gray-100 dark:border-white/5 flex items-center justify-between">
                    ...
                    <button aria-label={t('projects.viewStats') || 'Voir les stats du projet'} className="neumorph-button w-10 h-10 rounded-xl flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-primary">
